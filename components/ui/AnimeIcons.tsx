...
export const AnimeGithubIcon = ({ className = "w-6 h-6", ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
...
export const AnimeGoogleIcon = ({ className = "w-6 h-6", ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
  ...
  >
    <path
      d="M23.5 12.5c0 6.5-5 11.5-11.5 11.5C5.4 24 0 18.6 0 12S5.4 0 12 0c3 0 6 .8 8.5 2.5l-2 3C17.5 4 15 3 12 3 7 3 3 7 3 12s4 9 9 9c3.5 0 6.5-2 7.5-5h-7v-3h11z"
    />
    <path
      d="M20 2l3-2M18 5l2-1M21 21l3 3M18 19l2 1"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
...
export const AnimeEye = ({ className = "w-6 h-6", ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
  ...
  >
    ...
    <path d="M12 10l.5.5m3-3l-.5.5" strokeWidth="1.5" />
    <path d="M6 9l1 1" strokeWidth="1.5" />
    <path d="M18 9l-1 1" strokeWidth="1.5" />
  </svg>
);

export const AnimeEyeOff = ({ className = "w-6 h-6", ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
  ...
  >
    ...
    <path d="M8 8l-2-2" strokeWidth="1.5" />
    <path d="M16 16l2 2" strokeWidth="1.5" />
    <path d="M12 7l1-3m-1 3l-1-3" strokeWidth="1" />
  </svg>
);

export const AnimeAlert = ({ className = "w-6 h-6", ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
  ...
  >
    ...
    <path d="M6 18l1-2" strokeWidth="1" />
    <path d="M18 18l-1-2" strokeWidth="1" />
    <path d="M12 7l-2-2" strokeWidth="1" />
...
export const AnimeSleepIcon = ({ className = "w-6 h-6", ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const AnimeCloseIcon = ({ className = "w-6 h-6", ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
