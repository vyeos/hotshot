...
import { AnimeEnergyIcon, AnimeSleepIcon, AnimeCloseIcon, AnimeCrownIcon } from "@/components/ui/AnimeIcons";
                    ...
                    >
                      {isWinner && (
                        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 bg-accent text-accent-foreground font-black px-3 py-1 rounded-full flex items-center gap-2 shadow-lg">
                          <AnimeCrownIcon className="w-4 h-4 fill-accent-foreground text-accent-foreground" />
                          WHITE FACED
                        </div>
                      )}
