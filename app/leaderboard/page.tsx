    ...
    return (
        <div className="container mx-auto px-4 py-8 pb-20 min-h-screen">
            ...
            <div className="flex flex-col md:flex-row items-end justify-center gap-6 md:gap-8 my-24 px-4">
                {/* 2nd Place */}
                {second && (
                    <div className="order-2 md:order-1 flex flex-col items-center w-full md:w-1/3 max-w-[300px]">
                ...
                {/* 1st Place */}
                {first && (
                    <div className="order-1 md:order-2 flex flex-col items-center w-full md:w-1/3 max-w-[340px] z-10 -mt-8 md:-mt-12">
                ...
                {/* 3rd Place */}
                {third && (
                    <div className="order-3 flex flex-col items-center w-full md:w-1/3 max-w-[300px]">
                ...
                <div className="max-w-6xl mx-auto space-y-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        {rest.map((img, idx) => (
                            ...
                            >
                                {/* Rank Badge */}
                                <div className="absolute top-2 left-2 z-10 bg-background/60 backdrop-blur-md px-3 py-1 rounded text-sm font-black text-muted-foreground border border-primary/10">
                                    #{idx + 4}
                                </div>
                                ...
                                <div className="absolute bottom-0 left-0 w-full p-3 bg-background/80 backdrop-blur-sm border-t border-primary/5">
                                    <div className="flex items-center justify-center gap-2 font-mono font-bold text-lg text-primary">
